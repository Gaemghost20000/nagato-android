...
import com.nagato.agent.app.event.SystemEventReceiver;
import com.nagato.agent.app.terminal.TermuxTerminalSessionActivityClient;
import com.nagato.agent.app.terminal.TermuxTerminalSessionServiceClient;
import com.nagato.agent.shared.termux.plugins.TermuxPluginUtils;
import com.nagato.agent.shared.data.IntentUtils;
import com.nagato.agent.shared.net.uri.UriUtils;
import com.nagato.agent.shared.errors.Errno;
import com.nagato.agent.shared.shell.ShellUtils;
import com.nagato.agent.shared.shell.command.runner.app.AppShell;
import com.nagato.agent.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.nagato.agent.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.nagato.agent.shared.termux.shell.TermuxShellUtils;
import com.nagato.agent.shared.termux.TermuxConstants;
import com.nagato.agent.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.nagato.agent.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.nagato.agent.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.nagato.agent.shared.termux.shell.TermuxShellManager;
import com.nagato.agent.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.nagato.agent.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.nagato.agent.shared.logger.Logger;
import com.nagato.agent.shared.notification.NotificationUtils;
import com.nagato.agent.shared.android.PermissionUtils;
import com.nagato.agent.shared.data.DataUtils;
...
import com.nagato.agent.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.nagato.agent.emulator.TerminalEmulator;
import com.nagato.agent.emulator.TerminalSession;
import com.nagato.agent.emulator.TerminalSessionClient;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    private void runStartForeground() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
            startForeground(TermuxConstants.TERMUX_APP_NOTIFICATION_ID, buildNotification(), android.content.pm.ServiceInfo.FOREGROUND_SERVICE_TYPE_SPECIAL_USE);
        } else {
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.nagato.agent.shared.R.string.error_execution_cancelled))) {
