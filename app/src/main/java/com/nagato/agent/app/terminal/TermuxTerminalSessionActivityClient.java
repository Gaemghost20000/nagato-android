...
import com.nagato.agent.shared.termux.terminal.io.BellHandler;
import com.nagato.agent.shared.logger.Logger;
import com.nagato.agent.emulator.TerminalColors;
import com.nagato.agent.emulator.TerminalSession;
import com.nagato.agent.emulator.TerminalSessionClient;
import com.nagato.agent.emulator.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.nagato.agent.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.nagato.agent/com.nagato.agent.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
