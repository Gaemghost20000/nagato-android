...
import com.nagato.agent.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link com.nagato.agent.emulator.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.nagato.agent.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
