...
import com.nagato.agent.shared.reflection.ReflectionUtils;
...
import com.nagato.agent.shared.android.PackageUtils;
import com.nagato.agent.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.nagato.agent`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.nagato.agent/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.nagato.agent" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.nagato.agent.shared.R.raw.apt_info_script);
        try {
