package com.nagato.agent.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.nagato.agent.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.nagato.agent/10xxx}
             */
