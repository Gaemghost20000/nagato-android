package com.nagato.agent.shared.activities;
...
import com.nagato.agent.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.nagato.agent.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.nagato.agent.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
