package com.nagato.agent.shared.termux.shell;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import com.nagato.agent.shared.errors.Error;
import com.nagato.agent.shared.file.filesystem.FileTypes;
...
public class TermuxShellUtils {
    ...
    public static String[] setupShellCommandArguments(@NonNull String executable, @Nullable String[] arguments) {
        ...
        // Use system linker to bypass W^X exec restriction on Android 14+
        // See: https://github.com/termux-play-store/termux-apps
        String elfToExec = interpreter != null ? interpreter : executable;
        if (elfToExec.startsWith(TermuxConstants.TERMUX_FILES_DIR_PATH)) {
            result.add("/system/bin/linker" + (android.os.Process.is64Bit() ? "64" : ""));
        }
