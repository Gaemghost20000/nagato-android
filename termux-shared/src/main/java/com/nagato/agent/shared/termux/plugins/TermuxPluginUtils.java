package com.nagato.agent.shared.termux.plugins;
...
import com.nagato.agent.shared.R;
import com.nagato.agent.shared.activities.ReportActivity;
import com.nagato.agent.shared.file.FileUtils;
import com.nagato.agent.shared.termux.file.TermuxFileUtils;
import com.nagato.agent.shared.shell.command.result.ResultConfig;
import com.nagato.agent.shared.shell.command.result.ResultData;
import com.nagato.agent.shared.errors.Errno;
import com.nagato.agent.shared.errors.Error;
import com.nagato.agent.shared.notification.NotificationUtils;
import com.nagato.agent.shared.termux.models.UserAction;
import com.nagato.agent.shared.termux.notification.TermuxNotificationUtils;
import com.nagato.agent.shared.termux.settings.preferences.TermuxPreferenceConstants;
import com.nagato.agent.shared.shell.command.result.ResultSender;
...
import com.nagato.agent.shared.termux.settings.preferences.TermuxPreferenceConstants.TERMUX_APP;
