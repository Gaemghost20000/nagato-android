package com.nagato.agent.shared.termux.file;

import static com.nagato.agent.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
...
import com.nagato.agent.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.nagato.agent` as secondary user will result
     * in `ls: /data/user/0/com.nagato.agent: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.nagato.agent` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.nagato.agent` where `10` is
